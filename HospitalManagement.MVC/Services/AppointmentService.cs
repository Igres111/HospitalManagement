...
namespace HospitalManagement.MVC.Services
{
    public class AppointmentService : IAppointmentService
    {
        ...
        public Task<ApiResult<PagedResponse<AppointmentResponse>>> GetAllAsync(AppointmentFilterViewModel filter, CancellationToken cancellationToken)
        {
        ...
        public Task<ApiResult<AppointmentResponse>> GetByIdAsync(int id, CancellationToken cancellationToken)
        {
            return _apiClient.GetAsync<AppointmentResponse>($"api/appointments/{id}", cancellationToken);
        }

        public Task<ApiResult<AppointmentResponse>> CreateAsync(CreateAppointmentRequest request, CancellationToken cancellationToken)
        {
            return _apiClient.PostAsync<CreateAppointmentRequest, AppointmentResponse>("api/appointments", request, cancellationToken);
        }

        public Task<ApiResult<AppointmentResponse>> UpdateAsync(int id, UpdateAppointmentRequest request, CancellationToken cancellationToken)
        {
