...
public class DoctorService : IDoctorService
{
    ...
    public Task<DoctorResponse> GetByIdAsync(int id, CancellationToken cancellationToken = default)
    {
        return _apiClient.GetAsync<DoctorResponse>($"api/doctors/{id}", cancellationToken);
    }

    public Task<DoctorResponse> CreateAsync(CreateDoctorRequest request, CancellationToken cancellationToken = default)
    {
        return _apiClient.PostAsync<CreateDoctorRequest, DoctorResponse>("api/doctors", request, cancellationToken);
    }

    public Task<DoctorResponse> UpdateAsync(int id, UpdateDoctorRequest request, CancellationToken cancellationToken = default)
    {
